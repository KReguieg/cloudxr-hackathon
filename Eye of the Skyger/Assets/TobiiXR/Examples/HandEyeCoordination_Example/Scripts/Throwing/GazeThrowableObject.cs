...
public class GazeThrowableObject : MonoBehaviour, IGazeFocusable
{
    ...
    [SerializeField, Tooltip("Multiplier for how much the lower end of the allowed difference from original throw to adjusted throw velocity.")]
    private float _lowerVelocityMultiplier = 0.8f;

    [SerializeField, Tooltip("Multiplier for how much the upper end of the allowed difference from original throw to adjusted throw velocity.")]
    private float _upperVelocityMultiplier = 2f;

    [SerializeField, Tooltip("Multiplier for how much the y component of the throw can be modified from original throw to adjusted throw velocity.")]
    private float _maxYVelocityModifier = 1.0f;

    [SerializeField, Tooltip("How many degrees left or right of the target the user is allowed to throw until it no longer adjusts.")]
