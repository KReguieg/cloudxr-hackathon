...
/// </summary>
[RequireComponent(typeof(G2OM_DebugVisualization))]
public class TobiiXRThrowingSceneManager : MonoBehaviour
{
#pragma warning disable 649
    [SerializeField]
    private GazeGrab _gazeGrabComponent;
#pragma warning restore 649
    ...
    private G2OM_DebugVisualization _visualization;
    ...
    private void Update()
    {
        // Pressing Space will toggle the G2OM visualization.
        if (Input.GetKeyUp(ToggleG2OMVisualizationKeyCode))
        {
            _visualization.ToggleVisualization();
        }
